...
$(document).ready(function documentReady() {
    ...
    // CSS classes
    $('body').append('<style>' +
        `.${FX_FAST}{-webkit-filter: blur(0px);-moz-filter: blur(0px);-o-filter: blur(0px);-ms-filter: blur(0px);filter: blur(0px);filter: url("data:image/svg+xml;utf8,${slotMachineBlurFilterFastString}");filter:progid:DXImageTransform.Microsoft.Blur(PixelRadius="5")}` +
        `.${FX_NORMAL}{-webkit-filter: blur(0px);-moz-filter: blur(0px);-o-filter: blur(0px);-ms-filter: blur(0px);filter: blur(0px);filter: url("data:image/svg+xml;utf8,${slotMachineBlurFilterMediumString}");filter:progid:DXImageTransform.Microsoft.Blur(PixelRadius="3")}` +
        `.${FX_SLOW}{-webkit-filter: blur(px);-moz-filter: blur(px);-o-filter: blur(px);-ms-filter: blur(px);filter: blur(px);filter: url("data:image/svg+xml;utf8,${slotMachineBlurFilterSlowString}");filter:progid:DXImageTransform.Microsoft.Blur(PixelRadius="1")}` +
        `.${FX_GRADIENT}{` +
